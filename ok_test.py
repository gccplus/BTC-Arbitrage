...
symbol = 'btc_usdt'
print okex_future_client.kline(symbol, '1min', contract_type)
...
#print okex_future_client.userinfo()
...
#print okex_future_client.position(symbol, contract_type)
...
i = 0
while True:
    for contract_type in ['this_week']:
        try:
